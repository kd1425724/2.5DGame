#include "TitleSceneBackGround.h"

void TitleSceneBackGround::Init()
{
	m_polygon = std::make_shared<KdSquarePolygon>();
	m_polygon->SetMaterial("Asset/Textures/GameScene/BackGround/TitleSceneBackGround.png");
...
void TitleSceneBackGround::Update()
{}
